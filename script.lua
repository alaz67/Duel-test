...
-- ============================================================
-- SECRET ANIM CHANGER GUI - SEPARATE WINDOW (HALF SIZE)
-- ============================================================
local function buildSecretAnimChanger()
	...
	-- HALF SIZE: 240x300 (compared to 480x520 main)
	local mainAC = Instance.new("Frame", guiAC)
	mainAC.Size = UDim2.new(0, 240, 0, 300)
	mainAC.Position = UDim2.new(0.5, -120, 0.5, -150)
	...
	titleAC.Size = UDim2.new(1, -20, 0, 20)
	...
	minBtnAC.MouseButton1Click:Connect(function()
		...
		TS:Create(mainAC, TweenInfo.new(0.25, Enum.EasingStyle.Quad), {
			Size = minimizedAC and UDim2.new(0, 240, 0, 35) or UDim2.new(0, 240, 0, 300)
		}):Play()
	...
	contentAC.Size = UDim2.new(1, -12, 1, -48)
	contentAC.Position = UDim2.new(0, 6, 0, 42)
	...
	scrollLayoutAC.Padding = UDim.new(0, 3)
	
	local scrollPaddingAC = Instance.new("UIPadding", scrollAC)
	scrollPaddingAC.PaddingLeft = UDim.new(0, 3)
	scrollPaddingAC.PaddingRight = UDim.new(0, 3)
	scrollPaddingAC.PaddingTop = UDim.new(0, 3)
	scrollPaddingAC.PaddingBottom = UDim.new(0, 6)
	...
	local function createAnimationButtonAC(buttonText, animData)
		...
		statusIcon.Position = UDim2.new(1, -22, 0, 0)
	...
	-- Build Animation Buttons (smaller font, compact)
