...
-- ============================================================
-- SECRET ANIM CHANGER GUI - SEPARATE WINDOW (DOUBLE SMALL)
-- ============================================================
local function buildSecretAnimChanger()
	...
	-- Double small: 170x220 (half of 340x440)
	local mainAC = Instance.new("Frame", guiAC)
	mainAC.Size = UDim2.new(0, 170, 0, 220)
	mainAC.Position = UDim2.new(0.5, -85, 0.5, -110)
	...
	Instance.new("UICorner", mainAC).CornerRadius = UDim.new(0, 8)
	...
	titleAC.Size = UDim2.new(1, -12, 0, 14)
	titleAC.Position = UDim2.new(0, 6, 0, 4)
	titleAC.BackgroundTransparency = 1
	titleAC.Text = "ANIM CHANGER"
	...
	minBtnAC.Size = UDim2.new(0, 18, 0, 18)
	minBtnAC.Position = UDim2.new(1, -22, 0, 4)
	...
	minBtnAC.ZIndex = 3
	Instance.new("UICorner", minBtnAC).CornerRadius = UDim.new(0, 4)
	...
	minBtnAC.MouseButton1Click:Connect(function()
		...
		TS:Create(mainAC, TweenInfo.new(0.25, Enum.EasingStyle.Quad), {
			Size = minimizedAC and UDim2.new(0, 170, 0, 28) or UDim2.new(0, 170, 0, 220)
		}):Play()
	...
	contentAC.Size = UDim2.new(1, -10, 1, -32)
	contentAC.Position = UDim2.new(0, 5, 0, 30)
	...
	scrollLayoutAC.Padding = UDim.new(0, 2)
	
	local scrollPaddingAC = Instance.new("UIPadding", scrollAC)
	scrollPaddingAC.PaddingLeft = UDim.new(0, 2)
	scrollPaddingAC.PaddingRight = UDim.new(0, 2)
	scrollPaddingAC.PaddingTop = UDim.new(0, 2)
	...
	local function createAnimationButtonAC(buttonText, animData)
		...
		statusIcon.Size = UDim2.new(0, 16, 1, 0)
		statusIcon.Position = UDim2.new(1, -18, 0, 0)
