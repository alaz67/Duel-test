-- Ace.cc Hub + Secret Duel Animation Changer
-- Based on Ace.cc source with Black/White Theme and Texture ID 6974075369
...
-- ============================================================
-- SECRET DUEL GUI (Animation Changer) - Black & White Theme
-- ============================================================
local function buildSecretDuelGUI()
	...
	mainSD.Visible = secretDuelVisible
	Instance.new("UICorner", mainSD).CornerRadius = UDim.new(0, 12)
	
	-- Background Texture ID 6974075369 (Black & White)
	...
	minBtnSD.BackgroundColor3 = COL_ROW
	minBtnSD.Text = "◄"
	...
	minBtnSD.MouseButton1Click:Connect(function()
		...
		TS:Create(mainSD, TweenInfo.new(0.25, Enum.EasingStyle.Quad), {
...
local function buildGui()
	...
	local function mkRow(h)
		...
		f.BackgroundColor3=Color3.fromRGB(0, 0, 0);f.BorderSizePixel=0;f.LayoutOrder=LO()
		f.ZIndex=6
	...
	-- SECRET DUEL TOGGLE IN INTERFACE TAB
	local secretDuelRow = mkRow(40)
	mkLabel(secretDuelRow, "Secret Duel")
	local sdPill, sdDot = mkPill(secretDuelRow, 56)
	...
	local function setSDVisual(s)
		...
		if s then
			if not secretDuelGUI then buildSecretDuelGUI() end
...
local function loadConfigState()
	...
	-- Build Secret Duel GUI if enabled
...
buildGui()
loadConfigState()
print("Ace.cc Hub + Secret Duel Loaded")
print("discord.gg/Ace.cc")
